...
Source code lives at the root alongside these folders — use whatever structure your framework creates (`src/`, `app/`, `lib/`, etc.).
...
When solving non-obvious bugs or tricky problems, add a note to `docs/solutions/`. This compounds knowledge over time.
...
For significant features, create a plan in `docs/` before coding.
